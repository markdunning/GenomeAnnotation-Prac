...
\usecase
Read the results of the edgeR analysis. If you have a set of results from the RNA-seq practical, feel free to use these. Otherwise, you can find a set of results in the Day3 course directory. Take just the top 100 results to make the queries run quicker
